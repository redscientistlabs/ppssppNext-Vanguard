...
static const ConfigSetting generalSettings[] = {
	...
	ConfigSetting("CacheFullIsoInRam", &g_Config.bCacheFullIsoInRam, true, CfgFlag::DEFAULT), // RTC_Hijack: changed to default to true
...
static const ConfigSetting achievementSettings[] = {
	// Core settings
	ConfigSetting("AchievementsEnable", &g_Config.bAchievementsEnable, false, CfgFlag::DEFAULT), // RTC_Hijack: default to false
